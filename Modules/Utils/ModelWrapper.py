...
class ModelWrapper():
    ...
    def fit(self,
        ...
        last_improved = 0
        self.best_train_loss = 1e12 if best_train_loss is None else best_train_loss
        self.best_val_loss = 1e12 if best_val_loss is None else best_val_loss
        ...
        for epoch in range(initial_epoch, initial_epoch + epochs):
            ...
            for idx in range(train_batches_per_epoch):
                ...
                if verbose == 2:
                    ...
                    sys.stdout.write(('\r\x1b[KEpoch {0} {1}/{2}' + 
                        ...
                        ms_per_iter,
                        train_losses/train_batches_per_epoch) \
                            + remaining + '          ')
                    sys.stdout.flush()
            ...
            rel_diff = (self.best_train_loss - self.train_loss_list[-1])
            rel_diff /= self.best_train_loss
            ...
            if validation_data is not None:
                ...
                rel_diff = (self.best_val_loss - self.val_loss_list[-1])
                rel_diff /= self.best_val_loss
                if rel_diff > rel_save_thresh:
